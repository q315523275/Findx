...
namespace Findx.AspNetCore.Mvc.Models;
...
public class ControllerDescriptor
{
    ...
    protected virtual void InitArea()
    {
        ...
        if (attribute is AreaAttribute areaAttribute) Area = areaAttribute.RouteValue;
    }
    ...
    protected virtual void InitDescription()
    {
        ...
        if (attribute is DescriptionAttribute descriptionAttribute) Description = descriptionAttribute.Description;
    }
}