...
public static class UnitOfWorkExtensions
{
    ...
    /// <returns></returns>
    public static IRepository<TEntity> GetRepository<TEntity>(this IUnitOfWork uow)
    ...
    /// <typeparam name="TEntity"></typeparam>
    /// <returns></returns>
    public static IRepository<TEntity> WithUnitOfWork<TEntity>(this IRepository<TEntity> repo, IUnitOfWork uow)
        where TEntity : class, IEntity, new()
    {
        repo.UnitOfWork = uow;
        return repo;
