...
public static partial class Extensions
{
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    public static async Task<HttpResponseMessage> PostFileAsync(this HttpClient httpClient, string requestUri,
        IEnumerable<KeyValuePair<string, Stream>> files, IEnumerable<KeyValuePair<string, string>> formFields = null,
        CancellationToken cancellationToken = default)
    {
        if (files == null) return await httpClient.PostAsFormAsync(requestUri, formFields, cancellationToken);
